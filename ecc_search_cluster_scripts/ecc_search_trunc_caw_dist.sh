...
#PBS -N 3c66b_11_caw_dist
#PBS -q sbs0016
#PBS -l nodes=1:ppn=2,pvmem=12gb,walltime=168:00:00
#PBS -m abe
#PBS -M bdc0001@mix.wvu.edu
#PBS -e /scratch/bdc0001/jobs_out/3c66b_11_caw_dist.err
#PBS -o /scratch/bdc0001/jobs_out/3c66b_11_caw_dist.out
...
python ecc_search_fixed_forb_trunc.py --gwphi 0.62478505352 \
 ...
 --crn_type fixed \
 --psrs \
 --outdir /scratch/bdc0001/ecc_search_data/detection_runs/targeted/3c66b/truncated/no_1713/fixed_crn/caw_dist/11y/run1/ \
