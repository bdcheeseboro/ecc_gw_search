...
log10_mc = parameter.Uniform(7,10)('log10_Mc') #log10 chirp mass
e0 = parameter.Uniform(0.001, 0.9)('e0') #eccentricity
p_dist = parameter.Normal(0,1) #prior on pulsar distance
pphase = parameter.Uniform(0,2*np.pi) #prior on pulsar phase
gamma_P = parameter.Uniform(0,2*np.pi) #prior on angle of periastron
