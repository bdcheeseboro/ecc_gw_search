...
#PBS -e /scratch/bdc0001/jobs_out/3c66b_12_redo.err
#PBS -o /scratch/bdc0001/jobs_out/3c66b_12_redo.out
...
python ecc_search_fixed_forb_trunc.py --gwphi 0.62478505352 \
 ...
 --crn_type fixed \
 --outdir /scratch/bdc0001/ecc_search_data/detection_runs/targeted/3c66b/truncated/no_1713/fixed_crn/12y/run2/ \
