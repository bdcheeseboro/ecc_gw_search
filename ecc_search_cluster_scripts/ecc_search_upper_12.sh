...
#PBS -N 3c66b_12_up_vary_9
#PBS -q sbs0016
#PBS -l nodes=1:ppn=4,walltime=168:00:00
#PBS -m abe
#PBS -M bdc0001@mix.wvu.edu
#PBS -e /scratch/bdc0001/jobs_out/3c66b_12_up_vary.err
#PBS -o /scratch/bdc0001/jobs_out/3c66b_12_up_vary.out
...
python ecc_search_upper.py --gwphi 0.62478505352 \
 ...
 --crn_type vary \
 --outdir /scratch/bdc0001/ecc_search_data/upper_limit_runs/targeted/3c66b/vary_crn/12y/run9/ \
## --bayesephem \
