...
#PBS -N 3c66b_11_fixed_7
#PBS -q sbs0016
#PBS -l nodes=1:ppn=2,pvmem=12gb,walltime=168:00:00
#PBS -m abe
#PBS -M bdc0001@mix.wvu.edu
#PBS -e /scratch/bdc0001/jobs_out/3c66b_fixed.err
#PBS -o /scratch/bdc0001/jobs_out/3c66b_fixed.out
...
python ecc_search_fixed_forb.py --gwphi 0.62478505352 \
 ...
 --crn_type fixed \
 --outdir /scratch/bdc0001/ecc_search_data/detection_runs/targeted/3c66b/fixed_crn/11y/run7/ \
